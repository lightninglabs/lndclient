...
type LightningClient interface {
	...
	// AcceptChannel create a channel acceptor using the accept function
	...
	// parameter.
	AcceptChannel(ctx context.Context, timeout time.Duration,
...
// AcceptChannel create a channel acceptor using the accept function passed in.
// The timeout provided will be used to timeout the passed accept closure when
// it exceeds the amount of time we allow. Note that this amount should be
// strictly less than lnd's chanacceptor timeout parameter.
func (s *lightningClient) AcceptChannel(ctx context.Context,
